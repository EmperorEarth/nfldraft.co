export default function Logo({ height, size, width }) {
  if (!height || !width) {
    width = size;
    height = Math.round((size * 266.45081) / 378.82007);
  }
  return (
    <svg height={height} viewBox="0 0 378.82007 266.45081" width={width}>
      <g transform="matrix(1.25 0 0 -1.25 -190 625)">
        <g>
          <path
            d="m424 397c-1.6 0.812-1.4 2.26-0.248 3.12 13.6 10.1 22.9 23.1 22.9 43.1 0 23.7-17 57-83.3 57h-171l-38.7-67.5h28.4c3.18 0 5.74-2.56 5.74-5.73v-67.3c0-3.17-2.56-5.73-5.74-5.73h-30.5l39.1-67.2 181 0.0211c58.3 0 83.5 30.4 83.5 63.1 0 21.6-15.4 39.2-31 47.1"
            fill="#fff"
          />
          <path
            d="m323 408h-28.1v27c0.0264 2.83 2.32 5.12 5.16 5.12h22.9c13.5 0 18.4-6.86 18.4-15.8 0-9.5-5-16.3-18.4-16.3zm0-62.2h-22.9c-2.85 0-5.16 2.31-5.16 5.15v27h28.1c13.5 0 18.4-6.59 18.4-15.8 0-9.48-5-16.3-18.4-16.3zm80.2 49.2c-2.06 0.485-1.72 3.01-0.216 3.57 18.5 7.02 29.4 19.5 29.4 41.5 0.258 29.5-25.8 49.8-68.2 49.8h-161l-28.2-49.8h19.4c3.84 0 6.94-3.1 6.94-6.94v-80.4c0-3.84-3.1-6.94-6.94-6.94h-19.2l28.4-49.6 168 0.0211c48 0 67.7 31.9 67.7 55.3 0 20.6-15.2 38.4-36.3 43.5"
            fill="#fb4f14"
          />
